...
export function Footer() {
    ...
    return (
        <footer className="w-full bg-zinc-950 border-t border-zinc-900 text-zinc-400 py-16">
            ...
            <div className="container mx-auto px-4 mt-16 pt-8 pb-24 md:pb-8 border-t border-zinc-900/50 flex flex-col md:flex-row items-center justify-between gap-4">
                <p className="text-sm text-zinc-500 font-medium">
                    &copy; {new Date().getFullYear()} <span className="text-zinc-300">Platinum Billiard</span>. All rights reserved.
                </p>
                <div className="flex items-center gap-2 text-sm text-zinc-600 font-medium bg-zinc-950/50 px-4 py-2 rounded-full border border-zinc-800/50 shadow-inner">
                    <span>Designed & Built with</span>
                    <span className="text-emerald-500 animate-pulse">❤</span>
                    <span>by Platinum Team</span>
                </div>
            </div>
        </footer>
    );
